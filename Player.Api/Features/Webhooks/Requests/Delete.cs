...
public class Delete
{
    [DataContract(Name = "DeleteWebhookSubscriptionCommand")]
    ...
    public class Endpoint : IEndpoint
    {
        ...
        {
            return [
                group.MapDelete("webhooks/{id}", TypedHandler)
                    .WithName("deleteWebhookSubscription")
                    .WithDescription("Deletes the Webhook Subscription with the specified id.")
    ...
    public class Handler(IPlayerAuthorizationService authorizationService, PlayerContext db) : BaseHandler<Command>
    {
        ...
        {
            var toDelete = await db.Webhooks
