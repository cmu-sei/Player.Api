...
namespace Player.Api.Migrations.PostgreSQL.Migrations
{
    ...
    [Migration("20260921173904_Add_User_Identity_Attributes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Player.Api.Data.Data.Models.PermissionEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("df487ab3-e4d2-4879-8ba6-be626b5df5bc"),
                        ...
                        new
                        {
                            Id = new Guid("0c812be8-5a2a-4e61-b475-802efcc10fa2"),
                        ...
                        new
                        {
                            Id = new Guid("0189a1b9-d975-4f14-b93c-db652f7dc064"),
            ...
            modelBuilder.Entity("Player.Api.Data.Data.Models.TeamPermissionEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("37256f30-4a64-425d-86f1-e6302bedc702"),
                        ...
                        new
                        {
                            Id = new Guid("b7d05581-0ba4-442f-81d8-3da72ea6533e"),
                        ...
                        new
                        {
                            Id = new Guid("fbe821b7-4e5c-46f8-8c90-13fef17a680c"),
                        ...
                        new
                        {
                            Id = new Guid("43aee79a-a73a-4aa9-8928-256c86d82f6d"),
            ...
            modelBuilder.Entity("Player.Api.Data.Data.Models.TeamPermissionScopeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TeamId", "TargetTeamId")
                        .IsUnique();

                    b.ToTable("team_permission_scopes");
                });
            ...
            modelBuilder.Entity("Player.Api.Data.Data.Models.UserIdentityAttributeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("user_identity_attributes");
                });
            ...
            modelBuilder.Entity("Player.Api.Data.Data.Models.TeamPermissionScopeEntity", b =>
                {
                    b.HasOne("Player.Api.Data.Data.Models.TeamEntity", "TargetTeam")
                        .WithMany()
            ...
            modelBuilder.Entity("Player.Api.Data.Data.Models.ViewEntity", b =>
                {
                    b.HasOne("Player.Api.Data.Data.Models.TeamEntity", "DefaultTeam")
                        .WithMany()
